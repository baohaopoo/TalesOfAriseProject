...
HRESULT CSword::SetUp_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_STATIC, TEXT("Prototype_Component_Model_ForkLift"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CSword::SetUp_ConstantTable()
{
	...
	CTransform*		pPlayerTransform = (CTransform*)pGameInstance->Get_Component(LEVEL_TUTORIAL, TEXT("Layer_Player"), CGameObject::m_pTransformTag, 0);
