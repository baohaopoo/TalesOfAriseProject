...
namespace Engine
{
	...
	enum CHAR_TYPE { CHAR_TYPE_KISARA, CHAR_TYPE_RINWELL, CHAR_TYPE_SHIONNE, CHAR_TYPE_ALPHEN, CHAR_TYPE_NPC ,CHAR_TYPE_BOSS, CHAR_TYPE_MONSTER, CHAR_TYPE_BASIC, CHAR_TYPE_END
	};
