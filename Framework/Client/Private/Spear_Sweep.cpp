#include "stdafx.h"
#include "..\Public\Spear_Sweep.h"
#include "GameInstance.h"
#include "Animation.h"

CSpear_Sweep::CSpear_Sweep(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CBullet(pDeviceOut, pDeviceContextOut)
{

}

CSpear_Sweep::CSpear_Sweep(const CSpear_Sweep & rhs)
	: CBullet(rhs)
{
}

HRESULT CSpear_Sweep::NativeConstruct_Prototype()
{
...
HRESULT CSpear_Sweep::NativeConstruct(void * pArg)
{
...
void CSpear_Sweep::Tick(_double TimeDelta)
{
...
void CSpear_Sweep::LateTick(_double TimeDelta)
{
...
HRESULT CSpear_Sweep::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CSpear_Sweep::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CSpear_Sweep * CSpear_Sweep::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CSpear_Sweep*	pInstance = new CSpear_Sweep(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CSpear_Sweep"));
...
CGameObject * CSpear_Sweep::Clone(void * pArg)
{
	CSpear_Sweep*	pInstance = new CSpear_Sweep(*this);
