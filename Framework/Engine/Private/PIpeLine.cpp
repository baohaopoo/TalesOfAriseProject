...
_float4x4 CPipeLine::Get_LightTransformFloat4x4_TP(TRANSFORMSTATE eState)
{
	_float4x4		TransformMatrix;

	XMStoreFloat4x4(&TransformMatrix, XMMatrixTranspose(XMLoadFloat4x4(&m_LightTransformMatrix[eState])));
